...
/* Brand loading state: mark, sweeping bar, then the tagline as small secondary copy.
...
export function LoadingScreen() {
  return (
    ...
    >
      ...
      <div
        aria-hidden="true"
        className="animate-fade-up h-0.5 w-32 overflow-hidden rounded-full bg-glass-border [animation-delay:120ms] motion-reduce:animate-none"
      >
        <div className="h-full w-1/3 rounded-full bg-accent-primary animate-sweep motion-reduce:animate-none" />
      </div>
      <p className="animate-fade-up text-sm text-brand-300 [animation-delay:240ms] motion-reduce:animate-none">
